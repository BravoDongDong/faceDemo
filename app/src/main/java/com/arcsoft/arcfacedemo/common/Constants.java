...
public class Constants {
    ...
    public static final String APP_ID = "8K1CLAUTCs1KwQx654bdyDJpr2xcmwxy4R4KDr76QD7w";
    public static final String SDK_KEY = "BELsYcNwqPtdSPDeTW5zDKaaUhCsSydrm4jwX9aDgDEx";
